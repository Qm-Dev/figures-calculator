                ...
                def fig_2d():
                    ...
                    # Triángulo
                        ...
                        def triangulos():
                            ...
                            print("1 - Por medida de sus lados")
                            print("2 - Por la amplitud de sus ángulos")
                            print("3 - Trigonometría (Uso de lados y ángulos)")
                            print("4 - Obtención de ángulos")
                            ...
                            if option == 1:
                                ...
                                print("2 - Isóceles")
                                print("3 - Escaleno")
                                print("4 - Volver al menú de triángulos")
                                option = int(input("Clasificación: "))
                                ...
                                # Triángulo Escaleno
                                    ...
                                    if option == 2:
                                        ...
                                        if lado1 <= 0 or lado2 <= 0 or lado3 <= 0:
                                            ...
                                            print(
                                                f"El perímetro de este triángulo isóceles es de {perim_tr_esc:.2f} unidades.")
                                            time.sleep(5)
                                            print("Regresando al menú de triángulos...")
                                            time.sleep(2)
                                            triangulos()
                            ...
                            # Triángulos por amplitud de sus ángulos
                                ...
                                print("\nSeleccione el tríangulo.")
                                print("1 - Rectángulo")
                                print("2 - Volver al menú de triángulos")
                                option = int(input("Opción: "))
                            ...
                            # Trigonometría (Uso de lados y ángulos)
                                ...
                                # Cosecante
                                    ...
                                    if en_function == 1:
                                        ...
                                        if co <= 0 or hip <= 0:
                                            print(
                                                "Error: Los valores ingresados no puden albergar valores menores o iguales a"
                                                " cero.")
                                            time.sleep(3)
                                            print("Regresando al menú de triángulos...")
                                            time.sleep(2)
